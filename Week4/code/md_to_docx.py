...
用法 / Usage（仓库根目录 / from repo root）:
    .venv/Scripts/python.exe Week4/code/md_to_docx.py Week4/deliverables/第4周_DPO偏好对齐报告.md
    .venv/Scripts/python.exe Week4/code/md_to_docx.py <in.md> [out.docx]
"""
